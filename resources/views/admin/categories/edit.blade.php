...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.categories.update", [$category->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="longtitle">{{ trans('cruds.category.fields.title') }}</label>
                <input class="form-control {{ $errors->has('longtitle') ? 'is-invalid' : '' }}" type="text" name="longtitle" id="longtitle" value="{{ old('longtitle', $category->longtitle) }}" required>
              
            </div>
            <div class="form-group">
                <label class="required" for="max_hours">{{ trans('cruds.category.fields.max_hours') }}</label>
                <input class="form-control {{ $errors->has('max_hours') ? 'is-invalid' : '' }}" type="number" name="max_hours" id="max_hours" value="{{ old('max_hours', $category->max_hours) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('working_fn_from') ? 'is-invalid' : '' }}" type="text" name="working_fn_from" id="working_fn_from" value="{{ old('working_fn_from', $category->working_fn_from) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('working_fn_to') ? 'is-invalid' : '' }}" type="text" name="working_fn_to" id="working_fn_to" value="{{ old('working_fn_to', $category->working_fn_to) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('working_an_from') ? 'is-invalid' : '' }}" type="text" name="working_an_from" id="working_an_from" value="{{ old('working_an_from', $category->working_an_from) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('working_an_to') ? 'is-invalid' : '' }}" type="text" name="working_an_to" id="working_an_to" value="{{ old('working_an_to', $category->working_an_to) }}">
