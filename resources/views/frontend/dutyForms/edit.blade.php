    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.duty-forms.update", [$dutyForm->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_hours" id="total_hours" value="{{ old('total_hours', $dutyForm->total_hours) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="section_name" id="section_name" value="{{ old('section_name', $dutyForm->section_name) }}">
