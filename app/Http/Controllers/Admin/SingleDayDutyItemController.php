...
class SingleDayDutyItemController extends Controller
{
    public function index()
    {
        ...
        return view('admin.singleDayDutyItems.index', compact('singleDayDutyItems'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.singleDayDutyItems.create', compact('employees', 'forms'));
    }
    ...
    public function store(StoreSingleDayDutyItemRequest $request)
    {
        ...
        return redirect()->route('admin.single-day-duty-items.index');
    }
    ...
    public function edit(SingleDayDutyItem $singleDayDutyItem)
    {
        ...
        return view('admin.singleDayDutyItems.edit', compact('employees', 'forms', 'singleDayDutyItem'));
    }
    ...
    public function show(SingleDayDutyItem $singleDayDutyItem)
    {
        ...
        return view('admin.singleDayDutyItems.show', compact('singleDayDutyItem'));
    }
