                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.categories.update", [$category->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max_hours" id="max_hours" value="{{ old('max_hours', $category->max_hours) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="working_fn_from" id="working_fn_from" value="{{ old('working_fn_from', $category->working_fn_from) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="working_fn_to" id="working_fn_to" value="{{ old('working_fn_to', $category->working_fn_to) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="working_an_from" id="working_an_from" value="{{ old('working_an_from', $category->working_an_from) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="working_an_to" id="working_an_to" value="{{ old('working_an_to', $category->working_an_to) }}">
