        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.singleDayDutyItem.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.single-day-duty-items.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
