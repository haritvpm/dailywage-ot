    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.daily-wage-employees.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ten" id="ten" value="{{ old('ten', '') }}" required>
                            @if($errors->has('ten'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ten') }}
                                </div>
