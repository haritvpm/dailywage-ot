    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.session-duty-items.update", [$sessionDutyItem->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="fn_from">{{ trans('cruds.sessionDutyItem.fields.fn_from') }}</label>
                            <input class="form-control timepicker" type="text" name="fn_from" id="fn_from" value="{{ old('fn_from', $sessionDutyItem->fn_from) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="fn_to" id="fn_to" value="{{ old('fn_to', $sessionDutyItem->fn_to) }}">
                            @if($errors->has('fn_to'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fn_to') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="an_from" id="an_from" value="{{ old('an_from', $sessionDutyItem->an_from) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="an_to" id="an_to" value="{{ old('an_to', $sessionDutyItem->an_to) }}">
                            @if($errors->has('an_to'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('an_to') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_hours" id="total_hours" value="{{ old('total_hours', $sessionDutyItem->total_hours) }}" step="0.01">
