...
class SessionDutyController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.sessionDuties.index', compact('sessionDuties'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.sessionDuties.create', compact('employees', 'owned_bies', 'sessions'));
    }
    ...
    public function store(StoreSessionDutyRequest $request)
    {
        ...
        return redirect()->route('frontend.session-duties.index');
    }
    ...
    public function edit(SessionDuty $sessionDuty)
    {
        ...
        return view('frontend.sessionDuties.edit', compact('employees', 'owned_bies', 'sessionDuty', 'sessions'));
    }
    ...
    public function show(SessionDuty $sessionDuty)
    {
        ...
        return view('frontend.sessionDuties.show', compact('sessionDuty'));
    }
