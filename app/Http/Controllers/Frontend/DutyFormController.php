...
class DutyFormController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.dutyForms.create', compact('dates', 'employees', 'owned_bies', 'sessions'));
    }
    ...
    public function store(StoreDutyFormRequest $request)
    {
        ...
        return redirect()->route('frontend.duty-forms.index');
    }
    ...
    public function edit(DutyForm $dutyForm)
    {
        ...
        return view('frontend.dutyForms.edit', compact('dates', 'dutyForm', 'employees', 'owned_bies', 'sessions'));
    }
    ...
    public function show(DutyForm $dutyForm)
    {
        ...
        return view('frontend.dutyForms.show', compact('dutyForm'));
    }
