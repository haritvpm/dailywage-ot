...
class SessionDutyItemController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.sessionDutyItems.index', compact('sessionDutyItems'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.sessionDutyItems.create', compact('dates', 'forms'));
    }
    ...
    public function store(StoreSessionDutyItemRequest $request)
    {
        ...
        return redirect()->route('frontend.session-duty-items.index');
    }
    ...
    public function edit(SessionDutyItem $sessionDutyItem)
    {
        ...
        return view('frontend.sessionDutyItems.edit', compact('dates', 'forms', 'sessionDutyItem'));
    }
    ...
    public function show(SessionDutyItem $sessionDutyItem)
    {
        ...
        return view('frontend.sessionDutyItems.show', compact('sessionDutyItem'));
    }
