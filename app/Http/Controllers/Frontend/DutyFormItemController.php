...
class DutyFormItemController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.dutyFormItems.index', compact('dutyFormItems'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.dutyFormItems.create', compact('dates', 'employees', 'forms'));
    }
    ...
    public function store(StoreDutyFormItemRequest $request)
    {
        ...
        return redirect()->route('frontend.duty-form-items.index');
    }
    ...
    public function edit(DutyFormItem $dutyFormItem)
    {
        ...
        return view('frontend.dutyFormItems.edit', compact('dates', 'dutyFormItem', 'employees', 'forms'));
    }
    ...
    public function show(DutyFormItem $dutyFormItem)
    {
        ...
        return view('frontend.dutyFormItems.show', compact('dutyFormItem'));
    }
