...
class SingleDayDutyController extends Controller
{
    public function index()
    {
        ...
        return view('admin.singleDayDuties.index', compact('singleDayDuties'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.singleDayDuties.create', compact('dates', 'owned_bies'));
    }
    ...
    public function store(StoreSingleDayDutyRequest $request)
    {
        ...
        return redirect()->route('admin.single-day-duties.index');
    }
    ...
    public function edit(SingleDayDuty $singleDayDuty)
    {
        ...
        return view('admin.singleDayDuties.edit', compact('dates', 'owned_bies', 'singleDayDuty'));
    }
    ...
    public function show(SingleDayDuty $singleDayDuty)
    {
        ...
        return view('admin.singleDayDuties.show', compact('singleDayDuty'));
    }
