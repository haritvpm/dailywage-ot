...
class DailyWageEmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.dailyWageEmployees.index', compact('dailyWageEmployees'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.dailyWageEmployees.create', compact('categories', 'designations', 'sections'));
    }
    ...
    public function store(StoreDailyWageEmployeeRequest $request)
    {
        ...
        return redirect()->route('frontend.daily-wage-employees.index');
    }
    ...
    public function edit(DailyWageEmployee $dailyWageEmployee)
    {
        ...
        return view('frontend.dailyWageEmployees.edit', compact('categories', 'dailyWageEmployee', 'designations', 'sections'));
    }
    ...
    public function show(DailyWageEmployee $dailyWageEmployee)
    {
        ...
        return view('frontend.dailyWageEmployees.show', compact('dailyWageEmployee'));
    }
